 ...
 */
public class StateRepository<ENTITY, STATE, ID> {
    ...
    public interface From<ENTITY, STATE, ID> {
        To<ENTITY, STATE, ID> from(STATE... states);
    }


    @SuppressWarnings("unchecked")
    public interface To<ENTITY, STATE, ID> {
        CompleteTransition<ENTITY, STATE, ID> to(STATE... states);
    }

    @SuppressWarnings("unchecked")
    public interface CompleteTransition<ENTITY, STATE, ID> {
    ...
    public static class StateRepositoryBuilder<ENTITY, STATE, ID> {
        ...
        public static <ENTITY, STATE, ID> StateRepositoryBuilder<ENTITY, STATE, ID> configure() {
